...
Follow the full setup guide: app/SETUP.md

## Quick start

If you already have Python 3.10+ and PostgreSQL set up:
...
Copy `app/.env.example` to `app/.env` and set your database password before running. Create a PostgreSQL database.
